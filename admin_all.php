...
{
        $sn = $_POST['sn'];
        $query = "delete from wksinv where sn = '$sn'"; //delete query received from post method
...
web form echoed with button for delete asset option for 'admin only' access.
*/

$query = "select * from wksinv";
...
echo <<<_END
    ...
    refresh_date: $row[9]
        ...
        <form action="admin_all.php" method="post">
