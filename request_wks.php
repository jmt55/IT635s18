...
{
        $sn = $_POST['sn'];
        $query = "insert into wksrequest (user, sn) values" . "('$user', '$sn')" and "update wksinv set status = 'requested' where sn ='$sn'";//insert query values received from post method into wksrequest table
...
echo <<<_END
    ...
    refresh_date: $row[10]
        ...
        <form action="request_wks.php" method="post">
